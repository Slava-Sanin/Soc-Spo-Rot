			...
			<form id="RegisterForm" method="post" action="check_register.php">
				...
				<table class="form-table form-table-register">
					...
					<tr class="form-field">
						...
						<td>
							<input name="user_password" id="user_password" type="password" size="45" maxlength="50" value="" required /> Required
						</td>
					</tr>
				...
				<p class="submit">
					<input type="submit" class="button" name="Register_Submit" value="Register" />
